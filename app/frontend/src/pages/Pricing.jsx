  ...
  const pricingPlans = [
    {
      ...
      price: 0,
      priceId: null,
      description: "Perfect for trying out CrossPostMe",
      badge: null,
      features: [
        ...
        { text: "R.A.D.Ai features", included: false },
      ],
      cta: "Current Plan",
      popular: false,
    },
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const response = await api.post("/api/payments/create-checkout-session", {
        ...
        successUrl: `${window.location.origin}/marketplace/dashboard?payment=success`,
      ...
      <Dialog open={showPaymentDialog} onOpenChange={setShowPaymentDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              You're about to start a 7-day free trial of {selectedPlan?.name}.
          ...
          <div className="space-y-4 py-4">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-blue-800">
                ...
                <li>
                  ✓ After trial: ${selectedPlan?.price}/month (or downgrade to
                  free)
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="flex justify-between pt-2 border-t">
                <span className="font-semibold">After Trial:</span>
