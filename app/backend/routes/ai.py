...
from backend.models import AIAdRequest, AIAdResponse
...
async def generate_ad(request: AIAdRequest) -> AIAdResponse:
    # Mock AI generation
...
async def optimize_ad(title: str, description: str) -> dict[str, Any]:
    suggestions = [
