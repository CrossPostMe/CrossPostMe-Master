...
from backend.models import PlatformAccount, PlatformAccountCreate
...
async def store_platform_credentials(
    ...
    try:
        from backend.automation.base import PlatformCredentials
...
async def test_platform_credentials(
    ...
    try:
        from backend.automation import automation_manager
        from backend.automation.base import PlatformCredentials
