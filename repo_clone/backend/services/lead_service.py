...
class LeadService:
    ...
    async def find_or_create_lead(self, message_data: dict) -> Optional[str]:
        """
        ...
        try:
            ...
            if sender_name and sender_email:
                confidence_score, fuzzy_lead = await self._fuzzy_match_lead(
                    user_id, platform, sender_name, sender_email
                )
                ...
                if fuzzy_lead and confidence_score >= 0.8:  # 80% confidence threshold
                    ...
                    await self._update_lead_last_contact(fuzzy_lead["id"], message_data)
                    return fuzzy_lead["id"]
    ...
    async def _update_lead_last_contact(self, lead_id: str, message_data: dict) -> None:
    ...
    async def _fuzzy_match_lead(
        self, user_id: str, platform: str, name: str, email: str
    ...
    def _calculate_match_confidence(
        self, name1: str, email1: str, name2: str, email2: str
    ) -> float:
        """
