  ...
  return (
    <div className="flex items-center gap-2">
      <svg width={currentSize.icon} height={currentSize.icon} viewBox="0 0 40 40" fill="none">
        ...
        <path d="M20 8 L20 2 L18 4 M20 2 L22 4" stroke="url(#grad2)" strokeWidth="2.5" strokeLinecap="round" />
        <path d="M32 20 L38 20 L36 18 M38 20 L36 22" stroke="url(#grad2)" strokeWidth="2.5" strokeLinecap="round" />
        <path d="M20 32 L20 38 L18 36 M20 38 L22 36" stroke="url(#grad2)" strokeWidth="2.5" strokeLinecap="round" />
        <path d="M8 20 L2 20 L4 18 M2 20 L4 22" stroke="url(#grad2)" strokeWidth="2.5" strokeLinecap="round" />
        {/* Center circle */}
  ...
  return (
    <div className="flex items-center gap-2">
      <svg width={currentSize.icon} height={currentSize.icon} viewBox="0 0 40 40" fill="none">
        ...
        {/* Modern X shape */}
        <path d="M8 8 L32 32" stroke="url(#xgrad1)" strokeWidth="6" strokeLinecap="round" />
        <path d="M32 8 L8 32" stroke="url(#xgrad1)" strokeWidth="6" strokeLinecap="round" />
        <circle cx="20" cy="20" r="4" fill="white" stroke="url(#xgrad1)" strokeWidth="2" />
      </svg>
      <div className={`${currentSize.text} font-bold`}>
    ...
    <div className="flex items-center gap-2">
      <div className="relative" style={{ width: currentSize.icon, height: currentSize.icon }}>
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <span className="text-white font-black text-2xl transform -rotate-45">X</span>
        </div>
      </div>
  ...
  return (
    <div className="flex items-center gap-2">
      <svg width={currentSize.icon} height={currentSize.icon} viewBox="0 0 40 40" fill="none">
        ...
        <line x1="6" y1="6" x2="34" y2="34" stroke="url(#xgrad3)" strokeWidth="3" strokeLinecap="round" />
        <line x1="34" y1="6" x2="6" y2="34" stroke="url(#xgrad3)" strokeWidth="3" strokeLinecap="round" />
        {/* Corner nodes */}
        ...
        {/* Center node */}
        <circle cx="20" cy="20" r="5" fill="white" stroke="url(#xgrad3)" strokeWidth="2" />
      </svg>
      <div className={`${currentSize.text} font-bold`}>
