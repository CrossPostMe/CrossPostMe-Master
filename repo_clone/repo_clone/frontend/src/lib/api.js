...
export const api = {
  ...
  post: (url, data, options = {}, navigate = null) => 
    apiCall(url, { method: 'POST', body: JSON.stringify(data), ...options }, navigate),
  put: (url, data, options = {}, navigate = null) => 
    apiCall(url, { method: 'PUT', body: JSON.stringify(data), ...options }, navigate),
  delete: (url, options = {}, navigate = null) => 
    apiCall(url, { method: 'DELETE', ...options }, navigate),
  patch: (url, data, options = {}, navigate = null) => 
    apiCall(url, { method: 'PATCH', body: JSON.stringify(data), ...options }, navigate),
};